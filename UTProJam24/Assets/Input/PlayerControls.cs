...
public partial class @PlayerControls : IInputActionCollection2, IDisposable
{
    ...
    public struct CheatsActions
    {
        ...
        public void SetCallbacks(ICheatsActions instance)
        {
            ...
            {
                @ToggleUI.started -= m_Wrapper.m_CheatsActionsCallbackInterface.OnToggleUI;
                @ToggleUI.performed -= m_Wrapper.m_CheatsActionsCallbackInterface.OnToggleUI;
                @ToggleUI.canceled -= m_Wrapper.m_CheatsActionsCallbackInterface.OnToggleUI;
                @UnlockLevels.started -= m_Wrapper.m_CheatsActionsCallbackInterface.OnUnlockLevels;
                @UnlockLevels.performed -= m_Wrapper.m_CheatsActionsCallbackInterface.OnUnlockLevels;
                @UnlockLevels.canceled -= m_Wrapper.m_CheatsActionsCallbackInterface.OnUnlockLevels;
                @UnlockOutfits.started -= m_Wrapper.m_CheatsActionsCallbackInterface.OnUnlockOutfits;
                @UnlockOutfits.performed -= m_Wrapper.m_CheatsActionsCallbackInterface.OnUnlockOutfits;
                @UnlockOutfits.canceled -= m_Wrapper.m_CheatsActionsCallbackInterface.OnUnlockOutfits;
                @RandomOutfit.started -= m_Wrapper.m_CheatsActionsCallbackInterface.OnRandomOutfit;
                @RandomOutfit.performed -= m_Wrapper.m_CheatsActionsCallbackInterface.OnRandomOutfit;
                @RandomOutfit.canceled -= m_Wrapper.m_CheatsActionsCallbackInterface.OnRandomOutfit;
            }
